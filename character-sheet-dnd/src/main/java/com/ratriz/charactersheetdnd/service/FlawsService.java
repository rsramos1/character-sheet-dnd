...
import com.ratriz.charactersheetdnd.repository.FlawsRepository;
import com.ratriz.charactersheetdnd.util.ParseUtil;

@Service
public class FlawsService extends AbstractService<Flaws, Long> {

	@Autowired
	private FlawsRepository repository;

	@Override
	protected JpaRepository<Flaws, Long> getRepository() {
		return this.repository;
	}

	@Override
	public Page<FlawsDTO> findDto(Map<String, String> params, Pageable pageRequest) {
	...
	@Override
	public FlawsDTO findOneRandom(Map<String, String> params) {
