...
import com.ratriz.charactersheetdnd.repository.FamilyNameRepository;
import com.ratriz.charactersheetdnd.util.ParseUtil;

@Service
public class FamilyNameService extends AbstractService<FamilyName, Long> {

	@Autowired
	private FamilyNameRepository repository;

	@Override
	protected JpaRepository<FamilyName, Long> getRepository() {
		return this.repository;
	}
	
	@Override
	public Page<FamilyNameDTO> findDto(Map<String, String> params) {
		return findDto(params, ConstantPages.PAGE_REQUEST);
	}

	@Override
	public Page<FamilyNameDTO> findDto(Map<String, String> params, Pageable pageRequest) {
	...
	@Override
	public FamilyNameDTO findOneRandom(Map<String, String> params) {
